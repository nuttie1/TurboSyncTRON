...
public class DeviceDAO implements DAO{
    ...
    public List<Device> getDevices(String name) {
        ...
        String sql = "SELECT Devices.DeviceID, Devices.DeviceName, Devices.DeviceDesc, Devices.IsFavorite, Devices.DeviceControl, Devices.Format, Devices.Unit " +
                ...
                "WHERE users.Name = ?";
         populateDeviceList(name, deviceList, sql);

        return deviceList;
    }

    /** Populate devicelist based on username
     * 
     * @param userName users name
     * @param deviceList list to be populated
     * @param sql query to populate the list
     * @throws SQLException
     */
    private void populateDeviceList(String userName, List<Device> deviceList, String sql) {
        try {
   ...
   public List<Device> getFavoriteDevices(String name) throws SQLException {
       ...
       populateDeviceList(name, favDevices, sql);
